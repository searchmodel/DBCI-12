...
file = open(path+'/新思路梳理-备份baseline-20170108230000/新思路梳理/6.基于crf预测结果/topic_word_crf_tag.csv',encoding="UTF-8")
topic_word_crf_train_valid_file = open(path+'/新思路梳理-备份baseline-20170108230000/新思路梳理/6.基于crf预测结果/code/验证test.txt', 'w+',encoding='UTF-8')

zheng_file = open(path+'/新思路梳理/1.训练集构建词典/正_word_file.txt',encoding="UTF-8")
fu_file = open(path+'/新思路梳理/1.训练集构建词典/负_word_file.txt',encoding="UTF-8")
zhong_file = open(path+'/新思路梳理/1.训练集构建词典/中_word_file.txt',encoding="UTF-8")
zhengs = []
fus = []
zhongs = []
print("开始构建出数据...")
